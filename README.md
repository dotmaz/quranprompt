...
Use it for free: https://quranprompt.vercel.app/
...
2. Put your API key into this command and run it: `echo "OPENAI_API_KEY=YOUR_API_KEY" > .env`
3. Run `npm i && npm start && cd frontend && npm i && npm start`
4. Open `locahost:3000` in a browser
<br><br>
